...
class ApiBlocRetrofit extends Bloc<ApiEvent, ApiState> {
  final ApiServiceRetrofit apiService;

  ApiBlocRetrofit({required this.apiService}) : super(ApiInitial()) {
  ...
  Future<void> _deletePost(
    ...
    emit(ApiLoading());
    try {
      await apiService.deletePost(event.postId);
